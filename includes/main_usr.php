        ...
        <section class="cuerpo_juegos">
            ...
            <?php
                while($reg = mysqli_fetch_array($con_ej)){
                    echo "<a title='".$reg['nombre']."' href='ejecutaJuego.php?nombre=".$reg['nombre']."&sms=".$reg['rom_sms']."'>";
        ...
        <aside class="cuerpo_novedades">            
            ...
            <?php
                while($reg2 = mysqli_fetch_array($con2_ej)){
                    ...
                    $href= "ejecutaJuego.php?nombre=".$reg2['nombre']. " &sms=".$reg2['rom_sms'];

                    echo "<a href='". $href. "' class='subtitulo_novedades'>" . $reg2['titulo'] . "</a>";
                    echo "<br>";
                    echo "<p>". $reg2['leyenda'] . "</p>";
                }
            ?>
<!--
