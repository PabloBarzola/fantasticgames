<?php
    $folder = "imagenes/caratulas/";
	$maxlimit = 3500000;
	$allowed_ext = "jpg,png,gif,webp,jpeg";
	$overwrite = "yes";
	$match = "";     
	...
	if(isset($error)==true){        
		...
		// sudo chmod -R 777 /opt/lampp/htdocs/TP_WEBMASTER_2019/imagenes/caratulas
        if(move_uploaded_file($_FILES['caratula']['tmp_name'], $folder.$filename)){ // Finalmente sube el archivo
